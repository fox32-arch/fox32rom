...
monitor_shell_help_text:
    ...
    data.str "(l)ist   | list memory contents starting at address $0" data.8 10
    data.str "load     | load disk $0 sector $1 to buffer at address $2 of size $3 sectors" data.8 10
    data.str "(r)eg    | list contents of all registers" data.8 10
    data.str "save     | write disk $0 sector $1 from buffer at address $2 of size $3 sectors" data.8 10
    data.str "(s)et.SZ | set [$0] to $1; equivalent to `mov.SZ [$0], $1`" data.8 10
    data.8 0
